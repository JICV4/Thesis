...
class MALDITOF_ZSL_Dataset(h5torch.Dataset):
    def __init__(self, file, split_index = 0, in_memory = True, return_all_seqs = True, frac = "train", **kwargs):
        super().__init__(
            file,
            in_memory=in_memory,
...
class MALDITOFDataModule(LightningDataModule):
    def __init__(
        ...
        self.zsl = zsl_mode
        self.dataset_type = (MALDITOF_ZSL_Dataset if zsl_mode else MALDITOF_MC_Dataset)
